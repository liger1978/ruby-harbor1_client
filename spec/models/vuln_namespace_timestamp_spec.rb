...
# Unit tests for Harbor1Client::VulnNamespaceTimestamp
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VulnNamespaceTimestamp' do
  before do
    # run before each test
    @instance = Harbor1Client::VulnNamespaceTimestamp.new
  end
  ...
  describe 'test an instance of VulnNamespaceTimestamp' do
    it 'should create an instance of VulnNamespaceTimestamp' do
      expect(@instance).to be_instance_of(Harbor1Client::VulnNamespaceTimestamp)
    end
  end
