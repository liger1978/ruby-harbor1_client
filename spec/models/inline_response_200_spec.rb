...
# Unit tests for Harbor1Client::InlineResponse200
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200' do
  before do
    # run before each test
    @instance = Harbor1Client::InlineResponse200.new
  end
  ...
  describe 'test an instance of InlineResponse200' do
    it 'should create an instance of InlineResponse200' do
      expect(@instance).to be_instance_of(Harbor1Client::InlineResponse200)
    end
  end
