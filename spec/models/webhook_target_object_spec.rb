...
# Unit tests for Harbor1Client::WebhookTargetObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookTargetObject' do
  before do
    # run before each test
    @instance = Harbor1Client::WebhookTargetObject.new
  end
  ...
  describe 'test an instance of WebhookTargetObject' do
    it 'should create an instance of WebhookTargetObject' do
      expect(@instance).to be_instance_of(Harbor1Client::WebhookTargetObject)
    end
  end
