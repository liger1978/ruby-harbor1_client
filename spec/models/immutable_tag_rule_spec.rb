...
# Unit tests for Harbor1Client::ImmutableTagRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImmutableTagRule' do
  before do
    # run before each test
    @instance = Harbor1Client::ImmutableTagRule.new
  end
  ...
  describe 'test an instance of ImmutableTagRule' do
    it 'should create an instance of ImmutableTagRule' do
      expect(@instance).to be_instance_of(Harbor1Client::ImmutableTagRule)
    end
  end
