...
# Unit tests for Harbor1Client::AdminJobScheduleObj
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdminJobScheduleObj' do
  before do
    # run before each test
    @instance = Harbor1Client::AdminJobScheduleObj.new
  end
  ...
  describe 'test an instance of AdminJobScheduleObj' do
    it 'should create an instance of AdminJobScheduleObj' do
      expect(@instance).to be_instance_of(Harbor1Client::AdminJobScheduleObj)
    end
  end
