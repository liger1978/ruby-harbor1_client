...
# Unit tests for Harbor1Client::WebhookLastTrigger
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookLastTrigger' do
  before do
    # run before each test
    @instance = Harbor1Client::WebhookLastTrigger.new
  end
  ...
  describe 'test an instance of WebhookLastTrigger' do
    it 'should create an instance of WebhookLastTrigger' do
      expect(@instance).to be_instance_of(Harbor1Client::WebhookLastTrigger)
    end
  end
