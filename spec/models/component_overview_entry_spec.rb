...
# Unit tests for Harbor1Client::ComponentOverviewEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComponentOverviewEntry' do
  before do
    # run before each test
    @instance = Harbor1Client::ComponentOverviewEntry.new
  end
  ...
  describe 'test an instance of ComponentOverviewEntry' do
    it 'should create an instance of ComponentOverviewEntry' do
      expect(@instance).to be_instance_of(Harbor1Client::ComponentOverviewEntry)
    end
  end
