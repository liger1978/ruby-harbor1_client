...
# Unit tests for Harbor1Client::WebhookPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookPolicy' do
  before do
    # run before each test
    @instance = Harbor1Client::WebhookPolicy.new
  end
  ...
  describe 'test an instance of WebhookPolicy' do
    it 'should create an instance of WebhookPolicy' do
      expect(@instance).to be_instance_of(Harbor1Client::WebhookPolicy)
    end
  end
