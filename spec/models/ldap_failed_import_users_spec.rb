...
# Unit tests for Harbor1Client::LdapFailedImportUsers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LdapFailedImportUsers' do
  before do
    # run before each test
    @instance = Harbor1Client::LdapFailedImportUsers.new
  end
  ...
  describe 'test an instance of LdapFailedImportUsers' do
    it 'should create an instance of LdapFailedImportUsers' do
      expect(@instance).to be_instance_of(Harbor1Client::LdapFailedImportUsers)
    end
  end
