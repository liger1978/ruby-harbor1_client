...
module Harbor1Client
  class LdapUsers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ldap_realname')
        self.ldap_realname = attributes[:'ldap_realname']
      end

      if attributes.has_key?(:'ldap_email')
        self.ldap_email = attributes[:'ldap_email']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ldap_realname == o.ldap_realname &&
          ldap_email == o.ldap_email
    end
    ...
    def hash
      [ldap_username, ldap_realname, ldap_email].hash
    end
