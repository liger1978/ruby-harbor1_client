...
module Harbor1Client
  class ProjectSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'master_count')
        self.master_count = attributes[:'master_count']
      end
    ...
    def hash
      [repo_count, chart_count, project_admin_count, master_count, developer_count, guest_count, quota].hash
    end
