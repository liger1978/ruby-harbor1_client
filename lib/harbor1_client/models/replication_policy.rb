...
module Harbor1Client
  class ReplicationPolicy
    ...
    # The source registry.
    attr_accessor :src_registry

    # The destination registry.
    attr_accessor :dest_registry

    # The destination namespace.
    attr_accessor :dest_namespace
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'src_registry')
        self.src_registry = attributes[:'src_registry']
      end

      if attributes.has_key?(:'dest_registry')
        self.dest_registry = attributes[:'dest_registry']
      end

      if attributes.has_key?(:'dest_namespace')
        self.dest_namespace = attributes[:'dest_namespace']
      end
      ...
      if attributes.has_key?(:'deletion')
        self.deletion = attributes[:'deletion']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          src_registry == o.src_registry &&
          dest_registry == o.dest_registry &&
          dest_namespace == o.dest_namespace &&
          trigger == o.trigger &&
          filters == o.filters &&
          deletion == o.deletion &&
          override == o.override &&
    ...
    def hash
      [id, name, description, src_registry, dest_registry, dest_namespace, trigger, filters, deletion, override, enabled, creation_time, update_time].hash
    end
