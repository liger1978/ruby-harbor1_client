...
module Harbor1Client
  class Role
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'role_code')
      ...
      if attributes.has_key?(:'role_mask')
        self.role_mask = attributes[:'role_mask']
      end
    end
    ...
    def hash
      [role_id, role_code, role_name, role_mask].hash
    end
