...
module Harbor1Client
  ...
  class RetentionRuleMetadata
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rule_template')
        self.rule_template = attributes[:'rule_template']
      end
    ...
    def hash
      [rule_template, display_text, action, params].hash
    end
