...
module Harbor1Client
  ...
  class WebhookTargetObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'auth_header')
        self.auth_header = attributes[:'auth_header']
      end

      if attributes.has_key?(:'skip_cert_verify')
        self.skip_cert_verify = attributes[:'skip_cert_verify']
      end
    end
    ...
    def hash
      [type, address, auth_header, skip_cert_verify].hash
    end
