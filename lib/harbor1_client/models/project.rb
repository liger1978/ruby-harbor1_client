...
module Harbor1Client
  class Project
    ...
    attr_accessor :current_user_role_ids
    ...
    def self.swagger_types
      {
        ...
        :'current_user_role_ids' => :'Array<Integer>',
        :'repo_count' => :'Integer',
        :'chart_count' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'current_user_role_ids')
        if (value = attributes[:'current_user_role_ids']).is_a?(Array)
          self.current_user_role_ids = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_user_role_ids == o.current_user_role_ids &&
    ...
    def hash
      [project_id, owner_id, name, creation_time, update_time, deleted, owner_name, togglable, current_user_role_id, current_user_role_ids, repo_count, chart_count, metadata, cve_whitelist].hash
    end
