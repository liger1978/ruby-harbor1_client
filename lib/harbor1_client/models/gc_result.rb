...
module Harbor1Client
  class GCResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'job_kind')
        self.job_kind = attributes[:'job_kind']
      end
      ...
      if attributes.has_key?(:'job_status')
    ...
    def hash
      [id, job_name, job_kind, schedule, job_status, deleted, creation_time, update_time].hash
    end
