...
module Harbor1Client
  ...
  class WebhookLastTrigger
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'last_trigger_time')
        self.last_trigger_time = attributes[:'last_trigger_time']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_trigger_time == o.last_trigger_time
    end
    ...
    def hash
      [event_type, enabled, creation_time, last_trigger_time].hash
    end
