...
module Harbor1Client
  ...
  class RegistryInfo
    ...
    attr_accessor :supported_resource_filters

    # The triggers that the registry supports
    attr_accessor :supported_triggers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'supported_resource_filters')
        if (value = attributes[:'supported_resource_filters']).is_a?(Array)
          self.supported_resource_filters = value
        end
      end

      if attributes.has_key?(:'supported_triggers')
        if (value = attributes[:'supported_triggers']).is_a?(Array)
          self.supported_triggers = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supported_resource_filters == o.supported_resource_filters &&
          supported_triggers == o.supported_triggers
    end
