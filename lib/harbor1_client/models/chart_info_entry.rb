...
module Harbor1Client
  ...
  class ChartInfoEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'total_versions')
        self.total_versions = attributes[:'total_versions']
      end
    ...
    def list_invalid_properties
      ...
      if @total_versions.nil?
        invalid_properties.push('invalid value for "total_versions", total_versions cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @total_versions.nil?
    ...
    def hash
      [name, total_versions, latest_version, created, updated, icon, home, deprecated].hash
    end
